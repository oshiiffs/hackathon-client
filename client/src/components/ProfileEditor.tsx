              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg bg-white border-[3px] border-ink px-3 py-2 text-sm text-ink font-medium disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-crimson"
                  />
                  <button
                    type="button"
                    onClick={addSkill}
